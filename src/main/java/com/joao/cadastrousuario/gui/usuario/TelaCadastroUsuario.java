...
public class TelaCadastroUsuario extends javax.swing.JDialog {
   ...
   private void cadastrarUsuario(){
       try{
           ...
           us.cadastrarUsuario(capturarUsuarioDaTela(pessoa));
           new TelaDeMensagem(this, "Usuario cadastrado com sucesso!").setVisible(true);
       }
       catch (Exception ex){
    ...
    private void initComponents() {
        ...
        jLabelBarra.setText("Cadastro de Usuario");
        ...
        setSize(new java.awt.Dimension(403, 278));
