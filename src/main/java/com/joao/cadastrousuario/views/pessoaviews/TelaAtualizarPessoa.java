...
public class TelaAtualizarPessoa extends javax.swing.JDialog {
    ...
    private Pessoa capturarPessoaDaTela() throws ParseException{
        ...
        Pessoa pessoa = new Pessoa(Integer.valueOf(jTextField_Id.getText()),
   ...
   private void atualizarPessoa(){
       try{
           ...
           ps.atualizarPessoa(capturarPessoaDaTela());
           new TelaDeMensagem(this, "Pessoa atualizada com sucesso!").setVisible(true);
       }
       catch (Exception ex){
    ...
    private void initComponents() {
        ...
        jPanel_telefone1 = new javax.swing.JPanel();
        ...
        jLabelBarra.setText("Atualizar Pessoa");
        ...
        jPanel_telefone1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 10, 5));

        jLabel_Id.setText("Id:");
        jLabel_Id.setPreferredSize(new java.awt.Dimension(80, 16));
        jPanel_telefone1.add(jLabel_Id);

        jTextField_Id.setPreferredSize(new java.awt.Dimension(250, 22));
        jPanel_telefone1.add(jTextField_Id);

        jPanel_corpo.add(jPanel_telefone1);
        ...
        jPanel_tipoDocumento.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 10, 5));
        ...
        setSize(new java.awt.Dimension(474, 502));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAtualizarPessoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAtualizarPessoa dialog = new TelaAtualizarPessoa(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JPanel jPanel_telefone1;
