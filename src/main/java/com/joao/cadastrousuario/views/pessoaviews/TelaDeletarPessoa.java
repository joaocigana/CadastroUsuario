...
public class TelaDeletarPessoa extends javax.swing.JDialog {

    public TelaDeletarPessoa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void deletarPessoa(){
        ...
        try{
        ps.deletarPessoa(Integer.valueOf(jTextField_Id.getText()));
    ...
    private void initComponents() {
        ...
        jLabel_Barra.setText("Deletar Pessoa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeletarPessoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaDeletarPessoa dialog = new TelaDeletarPessoa(new javax.swing.JFrame(), true);
